...
// AIWorkloadProfileSpec defines the desired state of AIWorkloadProfile
type AIWorkloadProfileSpec struct {
	...
	// foo is an example field of AIWorkloadProfile. Edit aiworkloadprofile_types.go to remove/update
	// +optional
