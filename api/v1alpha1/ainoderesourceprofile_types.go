...
// AINodeResourceProfileSpec defines the desired state of AINodeResourceProfile
type AINodeResourceProfileSpec struct {
	...
	// foo is an example field of AINodeResourceProfile. Edit ainoderesourceprofile_types.go to remove/update
	// +optional
